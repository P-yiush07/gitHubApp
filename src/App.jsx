function App() {
  ...
  <div class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="bg-white p-4 rounded-lg shadow-md w-80">
        <input type="text" class="w-full border rounded-lg p-2 mb-2" placeholder="Enter text"/>
        <button class="w-full bg-blue-500 text-white rounded-lg p-2 hover:bg-blue-600">
            Submit
        </button>
    </div>
    </div>
